...
export const ProductFilter=()=>{
    ...
    return(
        ...
        <div className="ecom-filter-sort flex-column">
            ...
            <label for="htl"><input className="filter-label"
            ...
            <label for="lth"><input className="filter-label" 
            id='lth'
